...
let createCounter = function(n){
    ...
    return function()
    {
        //closure Aceesing value inside innner function
        return n++; //Increment number by 1 on each function call
    }
}
let input = 10;
let counter = createCounter(input) //Passing value by reference
